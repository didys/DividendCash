...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"dividendcash", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"dividendcash", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"dividendcash", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
