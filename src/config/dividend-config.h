/* src/config/dividendcash-config.h.  Generated from dividendcash-config.h.in by configure.  */
/* src/config/dividendcash-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.dividendcash.io"

/* Define to the full name of this package. */
#define PACKAGE_NAME "DividendCash Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "DividendCash Core 3.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "dividendcash"
