...
public:
    CMainParams()
    {
        ...
        vSeeds.push_back(CDNSSeedData("dividendcashcashasia.ddns.net", "dividendcashcashasia.ddns.net"));     // Primary DNS Seeder from Fuzzbawls
        vSeeds.push_back(CDNSSeedData("dividendcashcasheurope.ddns.net", "dividendcashcasheurope.ddns.net"));    // Secondary DNS Seeder from Fuzzbawls
        vSeeds.push_back(CDNSSeedData("dividendcashcashusa.ddns.net", "dividendcashcashusa.ddns.net"));
...
public:
    CTestNetParams()
    {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "dividendcash-testnet.seed.fuzzbawls.pw"));
        //vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "dividendcash-testnet.seed2.fuzzbawls.pw"));
        //vSeeds.push_back(CDNSSeedData("s3v3nh4cks.ddns.net", "s3v3nh4cks.ddns.net"));
        //vSeeds.push_back(CDNSSeedData("192.168.100.2", "192.168.100.2"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 129); // Testnet dividendcash addresses start with 't' or 'u'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 14);  // Testnet dividendcash script addresses start with '6' or '7'
